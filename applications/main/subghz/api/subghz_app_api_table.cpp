...
/*
 * This file contains an implementation of a symbol table with the SubGhz app's
 * private symbols. It is used by the composite API resolver to load plugins
 * (radio_device_cc1101_ext) that reference the SubGhz app's internal APIs.
 */
